...
### Fixed
- fix: configure git and install uv for release workflow tests (#288) (1ae99a5)
- fix: run build before tests in release workflow (#285) (8fb14ed)
...
### Other Changes
- chore: bump version to 0.3.0-preview.1.1 (#289) (4aba4e2)
- Remove duplicate security vulnerability link from issue template config (#287) (e9b4df6)
- Add GitHub issue templates and require issues for PRs (#283) (59bdb32)
- update from comments (#282) (cecc236)
